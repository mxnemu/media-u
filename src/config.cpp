...
std::pair<ShortClipCreator*, ShortClipCreator::Config*> BaseConfig::cloneGifShortClipCreator() const {
...
std::pair<ShortClipCreator*, ShortClipCreator::Config*> BaseConfig::cloneWebmShortClipCreator() const {
